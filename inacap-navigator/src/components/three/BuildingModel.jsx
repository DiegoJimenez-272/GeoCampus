...
function GLBBuilding({ onReady }) {
  ...
  useEffect(() => {
    ...
    scene.traverse((child) => {
      ...
      if (!readyRef.current) {
        // Desactivamos las sombras automáticas porque consumen demasiados recursos en modelos grandes
  ...
  return (
    <group>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.08, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#e8edf4" roughness={0.9} />
      </mesh>
      <gridHelper args={[150, 75, '#c8d4de', '#dde5ed']} position={[0, -0.07, 0]} />
    </group>
  )
}
